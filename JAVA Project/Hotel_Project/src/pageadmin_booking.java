...
public class pageadmin_booking extends JFrame {
	...
	public void page() {
		...
		panel_Search.setForeground(new Color(255, 255, 255));
			   ...
			   // System.out.println(newsql);
			    ...
			    if(dateChooser.getDate()!=null && dateChooser_Out.getDate()!=null ) {
			     if (dateChooser_Out.getDate().getTime() < dateChooser.getDate().getTime()) {
			      ...
			      String dStart =dateFormat.format(  dateChooser.getDate() );
			      String dEnd = dateFormat.format(dateChooser_Out.getDate() );
			      
			      newsql +=String.format(" AND ((bookingDate BETWEEN '%s' AND '%s') OR (checkoutDate BETWEEN '%s' AND '%s'))",dStart,dEnd,dStart,dEnd);
			      System.out.println(newsql);
		...
		lblNewLabel_2_1_1_1.setFont(new Font("Arial Black", Font.BOLD, 11));
		...
		lblNewLabel_2_1_4_1.setFont(new Font("Arial Black", Font.PLAIN, 11));
